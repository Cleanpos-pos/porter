        ...
        content: (
            <>
                ...
                <div className="my-12 relative h-96 overflow-hidden rounded-lg">
                    <img src="sirloin_blog.png" alt="Perfectly Seared T-Bone Steak" className="w-full h-full object-cover" />
    ...
    },
    {
        ...
        content: (
            <>
                ...
                <div className="my-12 relative h-96 overflow-hidden rounded-lg">
                    <img src="gallery/signature-dish-1.jpg" alt="Sliced Sirloin Steak with Red Wine and Greens" className="w-full h-full object-cover" />
